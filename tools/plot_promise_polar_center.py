...
def visualize(epoch, model, data_loader, patients_dict, device, save_detection=None):
    ...
    for images, targets in data_loader:
        ...
        assert gt.shape[0] == len(patients_dict[name])
...
if __name__ == "__main__":
    ...
    if n_exp==1:
        experiment_name = 'residual_parallel_polarw_approx_focal_90_20_expsumr=2_unary_pair'
    elif n_exp==2:
        experiment_name = 'residual_parallel_polarw_0.4_approx_focal_120_20_explogs=2_unary_pair'
    elif n_exp==3:
        experiment_name = 'residual_parallel_polarw_approx_focal_120_10_expsumr=1_unary_pair_margin=10_random'
    elif n_exp==4:
        experiment_name = 'residual_parallel_polarw_approx_focal_120_10_explogs=2_unary_pair_margin=10_random'
