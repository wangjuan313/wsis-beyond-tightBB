...
class AtlasDetection(torchvision_wj.datasets.AtlasDetection):
    def __init__(self, root, image_folder, gt_folder, transforms, margin=0, random=False,
                 transform_generator=None, visual_effect_generator=None,
                 transform_parameters=TransformParameters()):
        super(AtlasDetection, self).__init__(root, image_folder, gt_folder, margin, random)
    ...
    def __getitem__(self, idx):
        img, target = super(AtlasDetection, self).__getitem__(idx)
...
def get_atlas(root, image_folder, gt_folder, transforms, margin=0, random=False,
                transform_generator=None, visual_effect_generator=None):
    ...
    dataset = AtlasDetection(root, image_folder, gt_folder, margin=margin, random=random,
