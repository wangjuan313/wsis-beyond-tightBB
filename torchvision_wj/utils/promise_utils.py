...
class PromiseDetection(torchvision_wj.datasets.PromiseDetection):
    def __init__(self, root, image_folder, gt_folder, transforms, margin=0, random=False,
        ...
        super(PromiseDetection, self).__init__(root, image_folder, gt_folder, margin, random)
...
def get_promise(root, image_folder, gt_folder, transforms, margin=0, random=False,
                transform_generator=None, visual_effect_generator=None):
    ...
    dataset = PromiseDetection(root, image_folder, gt_folder, margin=margin, random=random,
